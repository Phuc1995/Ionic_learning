...
Widget fijkCustomPanelBuilder(FijkPlayer player, FijkData data,
    BuildContext context, Size viewSize, Rect texturePos) {
  return _FijkCustomPanel(
      player: player,
...
class _FijkCustomPanel extends StatefulWidget {
  final FijkPlayer player;
  final BuildContext buildContext;
  final Size viewSize;
  final Rect texturePos;

  const _FijkCustomPanel({
  ...
  @override
  _FijkCustomPanelState createState() => _FijkCustomPanelState();
}
...
class _FijkCustomPanelState extends State<_FijkCustomPanel> {
