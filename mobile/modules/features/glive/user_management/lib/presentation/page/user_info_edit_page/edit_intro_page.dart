  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          TextButton(
              onPressed: () => _userStoreController.onPressedEditIntro(context: context, profile: widget.profile, textEditingController: _textEditingController),
              child: Text(
          ...
          children: <Widget>[
            ...
            Flexible(
              child: TextFieldWidget(
                ...
                errorText: (userStoreController.editIntro.value != '' &&
                        userStoreController.editIntro.value != widget.profile.intro)
                    ? null
