...
class _BirthDateVerifyState extends State<BirthDateVerify> {
  ...
  final AccountCompleteController _accountCompleteController =  Get.put(AccountCompleteController());
  @override
  Widget build(BuildContext context) {
    return TextFieldWidget(
      ...
      onTap: () async {
        ...
        DateTime? date = new DateTime(nowDate.year - 10, nowDate.month, nowDate.day);
        ...
        _accountCompleteController.birthdateController.value =  DateFormat('yyyy-MM-dd').parse('$birthdate').toString();
      },
