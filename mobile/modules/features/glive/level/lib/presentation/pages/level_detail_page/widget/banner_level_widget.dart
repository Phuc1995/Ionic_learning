...
class _BannerLevelWidgetState extends State<BannerLevelWidget> {
  ...
  void initState() {
    _initializeControllerFuture = Future.wait([
      _initSharedPrefs(),
      _levelDetailController.refreshIdolExperience(),
    ]);
    super.initState();
  }
        ...
        children: [
          Obx(()=>
            ...
            data: SliderThemeData(
                ...
                inactiveTrackColor: AppColors.grey3.withOpacity(0.1),
                ...
                valueIndicatorTextStyle: TextStyle(
                    ...
                    fontSize: 12.sp)),
            child: Slider(
              value: _levelDetailController.getValue(),
              ...
              divisions: 100,
              label: _levelDetailController.labelSlider(),
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  color: AppColors.nobel.withOpacity(0.6),
