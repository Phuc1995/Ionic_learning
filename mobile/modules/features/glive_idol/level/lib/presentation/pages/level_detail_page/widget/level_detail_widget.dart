      ...
      child: Container(
        ...
        child: Row(children: [
              ...
              child: Align(
                ...
                child: Row(
                  children: [
                    ...
                    if (_levelDetailController.currentExp >= levelDetailController.listItemDetail[index].minExp && _levelDetailController.currentExp <= levelDetailController.listItemDetail[index].maxExp
                        ||( index == 0 && _levelDetailController.currentExp > levelDetailController.listItemDetail[index].maxExp))...[
          ...
          Container(
            ...
            child: Center(
              child: Text(
                levelDetailController.listItemDetail[index].minExp.toString()+"-"+levelDetailController.listItemDetail[index].maxExp.toString(),
                style: TextStyle(
                  fontWeight: FontWeight.w400,
                  fontSize: 13.sp,
                  color: ConvertCommon().hexToColor("#444444"),
