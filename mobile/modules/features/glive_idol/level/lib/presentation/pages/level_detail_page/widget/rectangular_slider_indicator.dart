...
class RectangularSliderIndicator extends SliderComponentShape {
  const RectangularSliderIndicator();

  static const _RectangularSliderIndicatorPainter _pathPainter = _RectangularSliderIndicatorPainter();
...
class _RectangularSliderIndicatorPainter {
  const _RectangularSliderIndicatorPainter();

  static double _triangleHeight = 8.0.h;
  static double _labelPadding = 7.0.w;
  static double _preferredHeight = 32.0.h;
  static double _minLabelWidth = 40.0.w;
  static double _bottomTipYOffset = 6.0.h;
  static double _preferredHalfHeight = _preferredHeight / 2;
  static double _upperRectRadius = 20;
  ...
  void paint({
    ...
    final RRect upperRRect = RRect.fromRectAndRadius(upperRect, Radius.circular(_upperRectRadius));
