...
class AuthApiImpl implements AuthApiRepository {
  ...
  @override
  Future<Either<Failure,GatewayResponse>> login(AccountParams params) async {
    try{
  ...
  // Check Existing User:---------------------------------------------------------------------
  @override
  Future<Either<Failure,GatewayResponse>> checkExistingUser(CheckExistingUserParams params) async {
    try {
  ...
  // Register:---------------------------------------------------------------------
  @override
  Future<Either<Failure,GatewayResponse>> register(RegisterParams params) async {
    try{
  ...
  @override
  Future<Either<Failure,GatewayResponse>> linkAccount(LinkAccountParams params) async {
    try{
