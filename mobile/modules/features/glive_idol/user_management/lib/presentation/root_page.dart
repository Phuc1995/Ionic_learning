...
import 'package:user_management/presentation/controller/language/language_controller.dart';
...
import 'package:common_module/utils/i18n/glive_idol/translation.dart';
      ...
      home: FutureBuilder(
        ...
        builder: (BuildContext context, AsyncSnapshot<dynamic> snapshot) {
          if (snapshot.connectionState == ConnectionState.done) {
            return Obx(() => userController.isLoggedIn.value ? HomePage() : LoginPage());
          } else {
