      ...
      body: FutureBuilder<void>(
          ...
          builder: (context, snapshot) {
            if (snapshot.connectionState == ConnectionState.done) {
              return DeviceUtils.buildWidget(
                  context, _bodyRegister(userStoreController));
            } else {
            ...
            Padding(
              ...
              child: LoginTypeText(onPressed: () {
                ...
                if (this.userStoreController.loginWithPhone.value){
                  userStoreController.otpType.value = 'phone';
                } else userStoreController.otpType.value = 'mail';
