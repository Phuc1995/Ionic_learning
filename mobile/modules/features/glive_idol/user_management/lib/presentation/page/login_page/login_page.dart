...
class _LoginScreenState extends State<LoginPage> {
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Padding(
              ...
              child: LoginTypeText(onPressed: () async {
  ...
  Widget navigate(BuildContext context) {
    ...
    String whereToGo = userStoreController.isNewUser.value ? IdolRoutes.user_management.accountComplete : IdolRoutes.user_management.home;
    Modular.to.pushReplacementNamed(whereToGo);
