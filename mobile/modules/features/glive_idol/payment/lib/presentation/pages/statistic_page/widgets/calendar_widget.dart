...
class _CalendarWigetState extends State<CalendarWiget> {
  ...
  @override
  void initState() {
    _statisticController.changeTypeCalendar(FilterType.day);
    super.initState();
  }
      ...
      actions: [
        Row(mainAxisAlignment: MainAxisAlignment.center, children: <Widget>[
          RoundedButtonWidget(
            ...
            onPressed: () {
                if(_dateFromSelect == ""){
                  _dateFromSelect = _statisticController.fromDate.value;
                  _dateToSelect = _statisticController.toDate.value;
                }
  ...
  String ShowFilter() {
    if (_statisticController.typeSelect.value == FilterType.month) {
      return (DateFormat('MM-yyyy')
              .format(DateFormat("dd-MM-yyyy").parse(_statisticController.fromDate.value)) +
          '  -  ' +
          DateFormat('MM-yyyy')
              .format(DateFormat("dd-MM-yyyy").parse(_statisticController.toDate.value)));
    } else {
      return _statisticController.fromDate.value + '  -  ' + _statisticController.toDate.value;
    }
  }
}
