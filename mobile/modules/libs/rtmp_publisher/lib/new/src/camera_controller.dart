...
/// controllers will be disposed before initializing the new controllers.
///
/// Example using [CameraController]:
///
/// ```dart
/// final List<CameraDescription> cameras = async CameraController.availableCameras();
/// final CameraController controllers = CameraController(description: cameras[0]);
...
class CameraController {
  ...
  static const String _isDisposedMessage = 'This controllers has been disposed.';
  ...
  /// Details for the camera this controllers accesses.
  ...
  /// Deallocate all resources and disables further use of the controllers.
  Future<void> dispose() {
    _instance = null;
    _isDisposed = true;
